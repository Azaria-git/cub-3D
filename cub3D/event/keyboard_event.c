...
/*   Updated: 2025/11/19 14:13:10 by aravelom         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	key_hook(int keycode, void *param)
{
	...
	else if (keycode == K_SPACE)
	{
		...
		// {
		// 	data->cam_x = data->player.pos_x - (data->trap_w / (2 * TILE_SIZE));
		// 	data->cam_y = data->player.pos_y - (data->trap_h / (2 * TILE_SIZE));
		// }
		raycasting(data);
	}
	// if (data->show_trapeze)
	// 	cam_trapeze(keycode, data);
	return (0);
}
